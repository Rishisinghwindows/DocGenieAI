...
final class ToolItemTests: XCTestCase {
    ...
    func testAllCasesCount() {
        XCTAssertEqual(ToolItem.allCases.count, 23)
    }
    ...
    func testNewToolSections() {
        XCTAssertEqual(ToolItem.signPDF.section, "PDF Tools")
        XCTAssertEqual(ToolItem.cropPDF.section, "PDF Tools")
        XCTAssertEqual(ToolItem.metadataEditor.section, "PDF Tools")
        XCTAssertEqual(ToolItem.summarizePDF.section, "AI Tools")
        XCTAssertEqual(ToolItem.askPDF.section, "AI Tools")
        XCTAssertEqual(ToolItem.translatePDF.section, "AI Tools")
