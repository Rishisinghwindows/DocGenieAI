        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: AppSpacing.lg) {
                    ...
                    // Quick Access
                    settingsCard(title: "Quick Access", icon: "square.grid.2x2") {
                        settingsRow(icon: "folder", text: "My Files", badge: nil) {
                            showFiles = true
                        }
                        Divider().background(Color.appBorder)
                        settingsRow(icon: "clock.arrow.circlepath", text: "Chat History", badge: conversations.isEmpty ? nil : "\(conversations.count)") {
                            showHistory = true
                        }
                    }
                    ...
                    // Legal
                    settingsCard(title: "Legal", icon: "doc.text") {
                    ...
                    // Connect
                    settingsCard(title: "Connect", icon: "link") {
                        settingsRow(icon: "info.circle", text: "About", badge: nil) {
                            showAbout = true
                        }
                        Divider().background(Color.appBorder)
                        ...
                        settingsRow(icon: "square.and.arrow.up", text: "Share App", badge: nil) {
                            let url = URL(string: AppConstants.appStoreURL)!
            ...
            .sheet(isPresented: $showHistory) {
                ChatHistoryView(
                    ...
                    onSelect: { _ in showHistory = false },
            ...
            .alert("Clear All Memories?", isPresented: $showClearMemories) {
                ...
                Text("DocSage will forget everything it learned about you. This cannot be undone.")
            }
            ...
            Group {
                if memories.isEmpty {
                    EmptyStateView(
                        icon: "brain",
                        title: "No Memories",
                        message: "DocSage will remember important things you tell it, like your preferences and frequently used files."
                    )
                } else {
                    List {
