        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: AppSpacing.lg) {
                    ...
                    // Description
                    AppCard(style: .glass) {
                        Text("DocSage is your all-in-one document companion. Scan paper documents, manage your digital files, and unlock powerful PDF tools -- all enhanced by on-device artificial intelligence. No cloud uploads, no subscriptions. Your documents stay private and under your control.")
                            .font(.appBody)
                    ...
                    VStack(spacing: AppSpacing.xs) {
                        ...
                        Text("\u{00A9} 2026 DocSage. All rights reserved.")
                            .font(.appMicro)
