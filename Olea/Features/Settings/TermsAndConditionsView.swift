            ...
            ScrollView {
                VStack(alignment: .leading, spacing: AppSpacing.lg) {
                    section(title: "Agreement to Terms") {
                        "By downloading, installing, or using Olea (the \"App\"), you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use the App. We reserve the right to update or modify these terms at any time, and your continued use of the App constitutes acceptance of any changes."
                    }
