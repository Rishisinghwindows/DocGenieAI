...
final class KeywordMatchingProvider: AIResponseProvider {
    ...
    private static let greetingResponses = [
        "Hello! I'm Olea, your AI document assistant. I can help you with scanning, PDF tools, converting files, and extracting text. What would you like to do?",
        "Hey there! I'm Olea. I can scan documents, merge PDFs, extract text, and much more. How can I help?",
        "Hi! Welcome to Olea. I've got 23 tools ready to help with your documents. What do you need?",
        "Hello! Olea here. Whether it's scanning, converting, or editing PDFs — I've got you covered. What's on your mind?",
    ]
    ...
    func generateResponse(for input: String, conversationHistory: [ChatMessage]) async throws -> AIResponse {
        ...
        // MARK: General Knowledge (ChatGPT-like)
            ...
            response = "I'm **Olea**, your AI document assistant. I can scan, edit, convert, and analyze documents — all on-device, fully private. I also remember your preferences across conversations. Try asking me to compress a PDF or summarize a document!"
            badge = nil
